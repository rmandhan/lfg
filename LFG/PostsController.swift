...
class PostsController: TableViewController, UIPopoverPresentationControllerDelegate, AddPostDelegate, FilterPostsDelegate {
...
//                self.loadingIndicator.stopAnimating()
    ...
    @IBAction func filterBarButtonTapped(sender: AnyObject) {
        ...
        self.performSegueWithIdentifier("showFilterPopover", sender: self)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "presentAddNewPostView" {
            ...
            if let addNewPostVC = nvc.topViewController as? AddNewPostController {

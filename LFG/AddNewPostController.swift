...
class AddNewPostController: TableViewController, UITextFieldDelegate, UITextViewDelegate, OptionSelectedDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "showOptionsView" {
            ...
            let optionsVC = segue.destinationViewController as! OptionsController
